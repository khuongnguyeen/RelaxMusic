...
class OfflineAdapter(val context: Context,val list: MutableList<MusicOnlineMp3>, val inter: IMusic) : RecyclerView.Adapter<OfflineAdapter.HomeHolder>() {
    ...
    override fun onBindViewHolder(holder: HomeHolder, position: Int) {
        holder.albumText.text = list[position].songName.split(" ")[0]
        Glide.with(context)
